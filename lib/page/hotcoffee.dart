import 'dart:convert';
import 'package:Coffee_Shop/model/model_hot.dart';
...
class _hotcoffeeState extends State<hotcoffee> {
  Future<List<model_hot>> ReadJsonData() async {
    final jsondata =
        await rootBundle.rootBundle.loadString('assets/data/hotcoffee.json');
    final list = json.decode(jsondata) as List<dynamic>;
    return list.map((e) => model_hot.fromJson(e)).toList();
  }
                    ...
                    child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              "Please choose your favourite coffee",
                              style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 12,
                                  fontWeight: FontWeight.bold),
                ...
                child: FutureBuilder(
                  ...
                  builder: (context, data) {
                    if (data.hasError) {
                      ...
                      var items = data.data as List<model_hot>;
